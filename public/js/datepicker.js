...
datepicker.prototype.popGrid = function() {
	...
	if (curDay == this.date && this.currentDate == true) {
	    ...
	    gridCells += '\t\t<td id="' + this.id + '-day' + curDay + '" class="today" headers="' +
		this.id + '-' + this.dayNames[weekday].toLowerCase() + '" role="gridcell" aria-selected="false"  aria-label="'+ curDay +' ' + this.monthNames[this.month] + ' ' + this.year + '">' + curDay + '</td>';
	}
	else {
	    gridCells += '\t\t<td id="' + this.id + '-day' + curDay + '" headers="' +
		this.id + '-' + this.dayNames[weekday].toLowerCase() + '" role="gridcell" aria-selected="false"  aria-label="'+ curDay +' ' + this.monthNames[this.month] + ' ' + this.year + '">' + curDay + '</td>';
	}
...
datepicker.prototype.goToDate= function(jumpDate) {
    ...
    window.location = ("/" + year + "/" + this.monthNames[month] + "/" + day);
}
