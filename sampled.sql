...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2020 at 12:36 PM
...
INSERT INTO `events` (`ID`, `Topic`, `Abstract`, `Location`, `Date`, `Type`) VALUES
...
(24, 'Hello man', '<p><strong><a href=\"https://en.wikipedia.org/wiki/Hurricane_Fred_(2015)\" title=\"Hurricane Fred (2015)\">Hurricane Fred</a></strong>&nbsp;was the easternmost&nbsp;<a href=\"https://en.wikipedia.org/wiki/Atlantic_hurricane\" title=\"Atlantic hurricane\">Atlantic hurricane</a>&nbsp;ever to form in the&nbsp;<a href=\"https://en.wikipedia.org/wiki/Tropical_Atlantic\" title=\"Tropical Atlantic\">tropics</a>, and the first to move through Cape Verde&nbsp;<a href=\"https://en.wikipedia.org/wiki/1892_Atlantic_hurricane_season#Hurricane_Five\" title=\"1892 Atlantic hurricane season\">since 1892</a>. The second hurricane of the&nbsp;<a href=\"https://en.wikipedia.org/wiki/2015_Atlantic_hurricane_season\" title=\"2015 Atlantic hurricane season\">2015 Atlantic hurricane season</a>, Fred became a&nbsp;<a href=\"https://en.wikipedia.org/wiki/Saffir%E2%80%93Simpson_scale#Category_1\" title=\"Saffir–Simpson scale\">Category&nbsp;1 hurricane</a>&nbsp;on August&nbsp;31 as it approached Cape Verde, which was placed under a&nbsp;<a href=\"https://en.wikipedia.org/wiki/Tropical_cyclone_warnings_and_watches#Hurricane_warning\" title=\"Tropical cyclone warnings and watches\">hurricane warning</a>&nbsp;for the first time ever. The&nbsp;<a href=\"https://en.wikipedia.org/wiki/Barlavento_Islands\" title=\"Barlavento Islands\">Barlavento Islands</a>&nbsp;endured&nbsp;<a href=\"https://en.wikipedia.org/wiki/Gale\" title=\"Gale\">gales</a>&nbsp;and flooding rains as the eye of the hurricane paralleled their shorelines. Structural damage across&nbsp;<a href=\"https://en.wikipedia.org/wiki/Boa_Vista,_Cape_Verde\" title=\"Boa Vista, Cape Verde\">Boa Vista</a>&nbsp;and&nbsp;<a href=\"https://en.wikipedia.org/wiki/Sal,_Cape_Verde\" title=\"Sal, Cape Verde\">Sal</a>&nbsp;presented as leveled roofs, damaged homes and toppled utility poles. Farmers on&nbsp;<a href=\"https://en.wikipedia.org/wiki/S%C3%A3o_Nicolau,_Cape_Verde\" title=\"São Nicolau, Cape Verde\">S&atilde;o Nicolau</a>&nbsp;suffered crop and livestock losses when they saw their lands flood. Fred&#39;s rains, though destructive, alleviated a drought across the&nbsp;<a href=\"https://en.wikipedia.org/wiki/Sotavento_Islands\" title=\"Sotavento Islands\">Sotavento Islands</a>&nbsp;of Cape Verde. Elsewhere, violent seas along the West African shoreline destroyed fishing villages and submerged homes in Senegal. Between the coasts of West Africa and Cape Verde, nine people died in maritime incidents.</p>\n', 'hyd', '2020-05-24T18:30:00.000Z', 'placement');
...
INSERT INTO `sampletable` (`ID`, `Topic`, `Abstract`, `Author`) VALUES
(1, 'Title: Everyday Work Practices in Retail Banking and E-governance', 'This talk has two parts: the first on retail banking by Soumyo Das, and the second on e-governance by Rajesh.\r\n\r\nICTs, Everyday Work Practices and the Skill Question in Retail Banking in India: An Ethnographic Case Study -- According to a recent McKinsey report (2018), 45% of activities individuals are paid to perform in present times can be automated by adapting currently demonstrated technologies. Major concerns around this current phase of automation include the implications of AI-based automation on human skills and employability, understanding the process of deskilling and reskilling, and the process of redesigning occupations around such automation processes. Barely thirty years ago, similar concerns were raised about information technology (IT), which was considered to be the final answer to “the labour question” (Zuboff 1988). However, historical studies of automation have pointed out that in practice, notions of skill are not shaped by the introduction of new technologies alone, but rather by a complex relationship between technology, work and organisations (Spenner 1983, Adler 1988).  In this talk, I will explore this complex relationship within the organisational context of a Public Sector retail bank in India.\r\n', 'Soumyo Das and Rajesh Hanbal'),
(2, 'Thesis Title	 Architecture Model Based Safety Assurance and Validation Framework', 'Safety Assurance and validation of complex avionics systems has always been a challenge. Real time monitoring of safety critical parameters during hardware software integration testing is adopted as a method in some of the safety critical systems. Safety Parameters specific to execution platform Environment   and   specific to the domain, are identified and monitored.  This method can capture unexpected failures, but relatively late in the development life cycle. Hence   leads to revisions in requirements and design, resulting in time and cost overruns. This can be   avoided, if the safety analyst and system engineers could base their work on a common architecture model, utilizing model-based development, to manage complexity. The model can address safety and functionality requirements with equal emphasise. In an attempt towards this, AADL (Architecture Analysis and Design Language) and its error annex (EMV2) is   selected as modelling language. The model is   named as extended model as it is extending nominal model with fault behaviour. A Systematic method for arriving at extended model is required to incorporate all aspects of normal and faulty behaviour scenarios to be addressed. Such a modelling process is arrived at keeping in view of input and output completeness and state completeness. As further step in model-based development towards safety analysis, safety properties of the execution platform and avionics domain are derived from DO-178C, ARP 4761, ARP 4754, MIL-HDBK-516B and from domain experience. These safety properties also form part of our extended model, with the help of BLESS annex of AADL.  The model is further analysed using analysis capabilities provided by OSATE, making it more complete and consistent. But for safety validation and airworthiness certification of the system, safety properties and requirements are to be demonstrated in the actual execution environment. \r\nTowards this we propose a framework for automatic generation of safety validation test cases, from the extended Model. The framework is realised in the following \r\n', ' Gracy Joseph');
